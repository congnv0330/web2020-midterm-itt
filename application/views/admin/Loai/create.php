    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <h4 class="card-title"><i class="mdi mdi-format-list-bulleted-type"></i> Thêm loại hàng hóa</h4>          
        </div>
        <div class="card-body">
            <form action="#" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control " id="name" name="name" placeholder="Nhập loại hàng hóa" value="" required="">
                    </div>
                </div>
